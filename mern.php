...
-->
<?php 
setcookie('MernDevelopment',isset($_COOKIE['MernDevelopment'])?++$_COOKIE['MernDevelopment']:1);
?>
<!DOCTYPE html>
<html lang="zxx">
  <head>
  ...
  <body>
    <div class="wrap" id="home">
      ...
      <!-- //logo -->
          <div class="container my-lg-4 mb 4">
          <h1 style="text-align:center">MERN Stack Development</h1>
            <div style="width:70%;margin:0 auto;padding:40px" class="mb 4 templete">
              <img class="img-fluid" src="images/react-node.jpg"/>
