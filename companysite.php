...
-->
<?php 
setcookie('CompanyWebsite',isset($_COOKIE['CompanyWebsite'])?++$_COOKIE['CompanyWebsite']:1);
?>
<!DOCTYPE html>
<html lang="zxx">
  <head>
  ...
  <body>
    <div class="wrap" id="home">
      ...
      <!-- //logo -->
          <div class="container my-lg-4 mb 4">
          <h1 style="text-align:center">Design Your Personal CompanyWebsite</h1>
            <div style="width:70%;margin:0 auto;padding:40px" class="mb 4 templete">
              <img class="img-fluid" src="images/web.jpg"/>
              <p style="color:white;font-size:1.25em">
              A CompanyWebsiteging platform is a type of software or service that you use to create a CompanyWebsite so that you can publish your content online. Creating a CompanyWebsite involves several steps, but the first one is choosing a system that will best fit your needs. Without it, you cannot proceed to the other steps, and you cannot start your CompanyWebsiteging adventure.

You can safely say that a CompanyWebsiteging platform is a CMS (Content Management System) since it enables you to easily manage your content once you have your CompanyWebsite up and running. </p> 
            </div>
