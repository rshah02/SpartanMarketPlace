      ...
      <div class="container">
        ...
        <div class="main">
            ...
            <div class="col-md-12">
              <div class="banner-info">
                <h2 class="heading-banner text-capitalize">
                  Hi. We are <span>Online Market place.</span>
                </h2>
                <p class=" mt-3">
                  A Single selling place for
                  <span>Products and Services </span>lorem, at molestie arcu
                  pulvinar ut. Proin ac fermentum est. Cras mi ipsum,
              ...
              <div class="row middle-grids">
                <div class="col-lg-7 advantage-grid-info">
                  <div class="advantage_left">
                    ...
                    <h4>This is an Online Market place for SJSU</h4>
                    <p class="mb-4">
          ...
          <section class="skills" id="skills">
            <div class="inner-sec">
              <h3 class="heading text-capitalize mb-md-5 mb-4">
                Our Services and Products sells <span></span>
              </h3>
              <div class="row middle-grids">
                <div class="col-lg-6">
                  <div class="skills-left">
                    ...
                    <h5>personal blogs - 85%</h5>
                    <p class="mb-4 bg clr-eighty-five"></p>
                    <h5>Online food- 70%</h5>
          ...
          >
            <h2 style="text-align:center">
              <a href="mostvisited.php"
                >Click here to see five best products on this market place
              </a>
            </h2>
            <h2 style="text-align:center">
