...
-->
<?php 
setcookie('mobileAppDevelopment',isset($_COOKIE['mobileAppDevelopment'])?++$_COOKIE['mobileAppDevelopment']:1);
?>
<!DOCTYPE html>
<html lang="zxx">
  <head>
  ...
  <body>
    <div class="wrap" id="home">
      ...
      <!-- //logo -->
          <div class="container my-lg-4 mb 4">
          <h1 style="text-align:center">Mobile App Development</h1>
            <div style="width:70%;margin:0 auto;padding:40px" class="mb 4 templete">
              <img class="img-fluid" src="images/mobile-dev.png"/>
              <p style="color:white;font-size:1.25em">
              Today’s generation wants everything on their fingertips; this is the necessity of modern world. We provide customer oriented, productive and easy-to-use mobile solutions. Making every mobile applications intuitive, powerful and aesthetically harmonious is our idea.

We evaluate and enhance your business process that benefits the mobile applications to reach global audiences. With Adrixus, you can get started quickly ensuring high quality by testing on real devices to measure and improve your user engagement. </p> 
            </div>
