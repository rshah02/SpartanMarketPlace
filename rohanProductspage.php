    ...
    <div class="wrap" id="home">
      ...
      <div class="container">
        ...
        <div class="main">
          ...
          <section class="banner">
            <div class="col-md-12">
              <div class="banner-info">
                <h2 class="heading-banner text-capitalize">
                  Hi. I'm <span>Web Designer.</span>
                </h2>
                <p class=" mt-3">
                  Integer porttitor <span>mollisar </span>lorem, at molestie
                  arcu pulvinar ut. Proin ac fermentum est. Cras mi ipsum,
                  consectetur. Integer at tellus in ex iaculis accumsan nec
                  tristique justo. Aliquam dapibus iaculis enim, a dapibus nibh
                  convallis scelerisque.
                </p>
                <a href="#about" class="banner-button btn mt-md-5 mt-3 scroll"
                  >Read More</a
                >
              </div>
            </div>
              ...
              <div class="row middle-grids">
                <div class="col-lg-7 advantage-grid-info">
                  <div class="advantage_left">
                    <h2 class="heading text-capitalize mb-4">
                      About Me <span></span>
                    </h2>
                    <h4>I'm a Professional Web Designer</h4>
                    <p class="mb-4">
                      Nulla pellentesque mi non laoreet eleifend. Integer sed
                      porttitor mollisar lorem, at molestie arcust pulvinar ut.
                      Proina fermentum est. Cras mist ipsum, consectetur ipsum
                      in, egestas tellus ipsu vestibulum tellus accumsan nec
                      tristique justo.
                    </p>
          ...
          <section class="services" id="services">
            <div class="inner-sec-layer">
              ...
              <div class="row middle-grids">
                <div class="col-lg-4 col-md-6 service-in text-center">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Proina fermentum eset sed. Cras mist ipsum, dolor et
                        consectetur ipsum.
                      </p>
                    </div>
                  </div>
                ...
                <div
                  class="col-lg-4 col-md-6 service-in text-center mt-md-0 mt-4"
                >
                  <div class="card">
                    <div class="card-body">
                ...
                <div
                  class="col-lg-4 col-md-6 service-in text-center mt-lg-0 mt-4"
                >
                  <div class="card">
                    <div class="card-body">
              ...
              <div class="row middle-grids">
                <div class="col-lg-6">
                  <div class="skills-left">
                    <p class="card-text mb-4">
                      Proina fermentum eset sed. Cras mist ipsum, dolor et
                      consectetur ipsum cras mist ipsum dolor sit amet.
                    </p>
                ...
                <div class="col-lg-6 mt-lg-0 mt-4">
                  ...
                  <p class="">
                    Nulla pellentesque mi non laoreet eleifend. Integer sed
                    porttitor mollisar lorem, at molestie arcust pulvinar ut.
                    Proina fermentum est cras mist ipsum..
                  </p>
                </div>
              </div>
            </div>
          ...
          <section
            class="visited"
            style="background-color:#f6f6f6; padding:40px"
          >
            <h2 style="text-align:center">
              <a href="mostvisited.php"
                >Click here to see most five visted pages
              </a>
            </h2>
            <h2 style="text-align:center">
              <a href="lastvisited.php" style="color:red"
                >Click here to see Last five pages you visited on this site
              </a>
            </h2>
          </section>
          <!-- Projects -->
                ...
                <div class="col-md-3 col-6 gal-img">
                  <a href="adminsite.php"
                    ><img
                      ...
                      class="img-fluid"
                    />
                    <span class="Image">Admin website</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="blog.php"
                    ><img
                      ...
                      class="img-fluid"
                    />
                    <span class="Image">Personal Blogs</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="companysite.php"
                    ><img
                      src="images/web.jpg"
                      alt="news image"
                      class="img-fluid"
                    />
                    <span class="Image">Company websites</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="bootstrap.php"
                    ><img
                      ...
                      class="img-fluid"
                    />
                    <span class="Image">Bootstrap Design</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="htmldesign.php"
                    ><img
                      src="images/html-css.jpg"
                      alt="news image"
                      class="img-fluid"
                    />
                    <span class="Image">HTML/CSS</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="java.php"
                    ><img
                      ...
                      class="img-fluid"
                    />
                    <span class="Image">JAVA Development</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="mern.php"
                    ><img
                      src="images/react-node.jpg"
                      alt="news image"
                      class="img-fluid"
                    />
                    <span class="Image">MERN Stack Development</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="mean.php"
                    ><img
                      src="images/angular-js.jpg"
                      alt="news image"
                      class="img-fluid"
                    />
                    <span class="Image">MEAN Stack Development</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="mobileDevelopment.php"
                    ><img
                      src="images/mobile-dev.png"
                      alt="news image"
                      class="img-fluid"
                    />
                    <span class="Image">Mobile App Development</span>
                  </a>
                </div>
                <div class="col-md-3 col-6 gal-img">
                  <a href="wordpress.php"
                    ><img
                      ...
                      class="img-fluid"
                    />
                    <span class="Image">Wordpress blog Design</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <section class="edu-exp" id="edu-exp">
            <div class="inner-sec">
              <h3 class="heading text-capitalize mb-md-5 mb-4">
                Education and Experience <span></span>
              </h3>
                    ...
                    <div class="row text-left">
                      <div class="col-lg-6 inner-w3pvt-wrap">
                        ...
                        <p>
                          ...
                          elit. Cras lobortis mollis arcu, vel vulputate justo.
                        </p>
                      </div>
                      <div class="col-lg-6 inner-w3pvt-wrap">
