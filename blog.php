...
-->
<?php 
setcookie('blog',isset($_COOKIE['blog'])?++$_COOKIE['blog']:1);
?>
<!DOCTYPE html>
<html lang="zxx">
  <head>
  ...
  <body>
    <div class="wrap" id="home">
      ...
      <!-- //logo -->
          <div class="container my-lg-4 mb 4">
          <h1 style="text-align:center">Design Your Personal Blog</h1>
            <div style="width:70%;margin:0 auto;padding:40px" class="mb 4 templete">
              <img class="img-fluid" src="images/blog.jpg"/>
...
You can safely say that a blogging platform is a CMS (Content Management System) since it enables you to easily manage your content once you have your blog up and running. </p> 
            </div>
